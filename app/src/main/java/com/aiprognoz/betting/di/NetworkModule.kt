...
object NetworkModule {
    ...
    @Singleton
    @Named("OddsApi")
    fun provideOddsApiRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl(OddsApiService.BASE_URL)
            .client(okHttpClient)
    ...
    @Provides
    @Singleton
    fun provideOddsApiService(@Named("OddsApi") retrofit: Retrofit): OddsApiService {
